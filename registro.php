                    ...
                    <li>
                      <div class="tabla-precio">
                        ...
                        <div class="Orden">
                            ...
                            <input type="number" min="1" id="pase_dia" size="3" placeholder="1">
                          </div>
                      </div>
                    </li>
                    <li>
                        <div class="tabla-precio">
                          ...
                          <div class="Orden">
                            ...
                            <input type="number" min="1" id="pase_completo" size="3" placeholder="1">
                          </div>
                        </div>
                    </li>
                    <li>
                        <div class="tabla-precio">
                          ...
                          <div class="Orden">
                            ...
                            <input type="number" min="1" id="pase_dosdias" size="3" placeholder="1">
                          </div>
                        </div>
                      </li>
                  </ul>
